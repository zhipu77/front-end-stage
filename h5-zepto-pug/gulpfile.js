...
var version = 'project-name' + pkg.version
var dev_version = 'project-name/' + md5(version).substring(0, 10)

console.log('=======================================================build version is '+dev_version)
...
gulp.task('concat', function() {
    return gulp.src(['./www/public/zepto.min.js'])
        .pipe(uglify())
        .pipe(concat('zepto.hercules.vera.js'), {
            newLine: ';'
        })
        .pipe(gulp.dest('./www/public/project-name/v1/'));
});

gulp.task('uglify', function() {
    return gulp.src(['./www/public/swipe.js'])
        .pipe(uglify())
...
gulp.task('html', function() {
    ...
    var staticDomain = isDev ? '/' : '//project-name.static.com/'
